...
public class NowPlayTaskLoader extends AsyncTaskLoader<ArrayList<MovieItem>> {
    private ArrayList<MovieItem> mData;
    private Boolean mHasResult = false;
    public static final String STAT_ASYNC = "AsynTaskLoader";

    public NowPlayTaskLoader(@NonNull Context context) {
        super(context);
        onContentChanged();
    }
    ...
    public ArrayList<MovieItem> loadInBackground() {
       ...
       // String url = Constant.BASE_URL + "/movie/now_playing?api_key=" + Constant.API_KEY + "&language=en-US";
        client.get(Constant.NOWPLAYING_URL, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
